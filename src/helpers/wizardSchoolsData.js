  ...
  [schools.THAUMATURGE]: {
    ...
    spells: {
      ...
      "Blinding light": {
        ...
        category: "Line of sight",
        description:
          "The target must make an immediate Will Roll with a Target Number equal to the Casting Roll. If it fails, it may not attack, shoot, or cast LINE_OF_SIGHT spells. Its Fight stat is reduced to +0 and its Move to 1. At the end of each turn, the figure may attempt another Will Roll with the same Target Number. If successful, the spell is cancelled.",
      },
      Heal: {
        castingNumber: 8,
        category: "Line of sight",
